...
import { X, ShieldAlert, Lock, Unlock, CheckCircle2, Settings, Globe } from 'lucide-react';
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <S.Header>
            <S.Title><Settings size={20} /> {t('settings.title')}</S.Title>
            <S.IconButton onClick={onClose} aria-label={t('common.cancel')}><X size={20} /></S.IconButton>
          </S.Header>
